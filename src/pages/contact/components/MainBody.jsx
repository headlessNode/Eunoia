	...
	return (
		<div className="main-body w-full flex flex-col items-center">
			<div className="max-w-8xl w-full font-afacad px-3">
				...
				<div className="pb-32 flex justify-center gap-80 flex-wrap">
					...
					<div className="flex flex-col gap-4">
						<input
							...
							name="name"
							id="name"
							className="w-96 h-10 px-2 rounded-lg text-xl text-black text-opacity-50 placeholder-black placeholder-opacity-50 bg-black bg-opacity-10"
							placeholder="Name"
						/>
						<input
							type="email"
							name="email"
							id="email"
							className="w-96 h-10 px-2 rounded-lg text-xl text-black text-opacity-50 bg-black bg-opacity-10 placeholder-black placeholder-opacity-50"
							placeholder="Email"
						/>
						<textarea
							name="message"
							...
							cols="30"
							rows="10"
							className="w-96 px-2 py-2 resize-y rounded-lg text-xl text-black text-opacity-50 bg-black bg-opacity-10 placeholder-black placeholder-opacity-50"
							placeholder="Message"
						></textarea>
